<%@ Page Language="C#" AutoEventWireup="true" CodeFile="选课及成绩维护.aspx.cs" Inherits="选课及成绩维护" %>
...
<head runat="server">
    ...
    <script>
        ...
        function first() {//第一次加载填充文本框
            ...
            document.getElementById("课程代号").value = document.getElementById("name").value;
            document.getElementById("成绩").value = document.getElementById("grade").value;
            document.getElementById("修课时间").value = document.getElementById("time").value;
        }
        ...
        function ajaxSent(nowPage) {
            ...
            xmlhttp.open("GET", "选课及成绩维护.aspx?nowPage=" + nowPage, true);//准备
            xmlhttp.send();//发送
        ...
        function fillText(stuArray) {//填充文本框，id要改对，不让js会停止执行，填充不了。
            ...
            document.getElementById("课程代号").value = stuArray[1];
            document.getElementById("成绩").value = stuArray[2];
            document.getElementById("修课时间").value = stuArray[3];
        }
        function clean() {
            document.getElementById("学号").value = "";
            document.getElementById("课程代号").value = "";
            document.getElementById("成绩").value = "";
        }
    </script>
</head>
<body>
            ...
            <tbody class="auto-style5">
                <tr>
                    <td class="auto-style8" colspan="3"><strong>
                        <asp:Label ID="Label1" runat="server" BorderStyle="Groove" CssClass="auto-style6" Text="选课及成绩维护"></asp:Label>
                    </strong></td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style7">
                        <asp:Button ID="删除记录" runat="server" Text="删除记录" />
                    </td>
                    <td class="auto-style7">
                ...
                <tr>
                    <td colspan="3" class="auto-style11">学号：&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    <td colspan="3" class="auto-style11">成绩：&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:TextBox ID="成绩" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style11" colspan="3">修课时间：&nbsp;&nbsp; 
                        <asp:TextBox ID="修课时间" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
