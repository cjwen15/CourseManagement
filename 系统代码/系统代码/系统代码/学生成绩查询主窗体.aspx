...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="select [学生情况].学号,[学生情况].姓名,[课程档案].课程代号,[课程档案].课程名称,[选课及成绩].成绩 from [学生情况],[课程档案],[选课及成绩] where [选课及成绩].课程代号=[课程档案].课程代号 and [选课及成绩].学号=[学生情况].学号"></asp:SqlDataSource>
            <div class="auto-style1">
